...
# Point cloud special tokens
POINT_CLOUD_START_TOKEN = "<pc_start>"
POINT_CLOUD_PATCH_TOKEN = "<pc_patch>"
POINT_CLOUD_END_TOKEN = "<pc_end>"

EXTRA_TOKENS = (IM_START_TOKEN, IM_END_TOKEN, IMAGE_PATCH_TOKEN,
                IM_COL_TOKEN, IMAGE_PROMPT, IMAGE_LOW_RES_TOKEN,
                POINT_CLOUD_START_TOKEN, POINT_CLOUD_PATCH_TOKEN, POINT_CLOUD_END_TOKEN)
...
class HfTokenizerWrapper:
    ...
    def __init__(self, tokenizer, bos_token_id=None, adds_space=False):
        ...
        # Point cloud tokens
        self.point_cloud_start_token_id = special_tokens[POINT_CLOUD_START_TOKEN]
        self.point_cloud_patch_token_id = special_tokens[POINT_CLOUD_PATCH_TOKEN]
        self.point_cloud_end_token_id = special_tokens[POINT_CLOUD_END_TOKEN]
