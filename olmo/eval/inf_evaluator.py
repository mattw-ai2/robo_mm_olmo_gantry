...
from .evaluators import (
    ...
    TempCompassEval, VideoMMEEval, MLVUGenEval, LongVideoBenchEval, PointProximityEval
)
...
class EvaluatorConfig(BaseConfig):
    ...
    point_proximity_eval: bool = False
    ...
    def build(self, default_save_dir=None) -> InfEvaluator:
        ...
        if self.point_proximity_eval:
            evaluators.append(PointProximityEval(self.num_wandb_examples))
        else:
            pass
